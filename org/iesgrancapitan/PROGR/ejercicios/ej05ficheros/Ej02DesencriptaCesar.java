...
/**
 * Programa que recibe como parámetro un fichero encriptado con el método César y almacena el resultado en otro, que también
 ...
 * - Si en el fichero destino no se puede escribir da error al abrirlo como lectura) el programa termina con un mensaje de error y
 *   código 2.
 *   
 * Para desencriptar necesitas una clave que hay que pedir al usuario.
 *   
 * @author rafa
 *
 */

public class Ej02DesencriptaCesar {
  ...
  /**
   * Pide el desplazamiento para desencriptar usando el método César.
  ...
  private static int desplazamientoCesar() {
    ...
    do {
      try {
        System.out.print("Desplazamiento para la desencriptación usando César: ");
