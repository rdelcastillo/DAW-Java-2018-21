...
public class PruebaEstadisticas {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("}");
    System.out.println("La media es    " + org.iesgrancapitan.PROGR.ejemplos.ej03funciones.estadisticas.Arrays.media(array));
    System.out.println("La varianza es " + org.iesgrancapitan.PROGR.ejemplos.ej03funciones.estadisticas.Arrays.varianza(array));
  }
